...
|-------------------------------------------------------------------------------------------|-------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
| [`latest` `v9.3.45`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Current Stable: Version 9.3.45 as of 2025-08-04 | [Change Log 9.3.45](https://community.ui.com/releases/UniFi-Network-Application-9-3-45/6f7eb802-3973-4258-8aeb-d257cd61e5c5) |
...
* **[web_gui_origin]/manage/default/devices?deviceUpdatesSettings** _or_ in the Unifi Controller web GUI, **UniFi Devices -> Device Updates and Settings** (It's near the top right of the page.)
* Scroll down to **Device Settings -> Inform Host Override:** (It's near the bottom of that page.)
